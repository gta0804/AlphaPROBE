...
_DEFAULT_API_KEY = os.getenv("ALPHAGEN_BST_API_KEY", "sk-4deb7c21bc32424290dfb2dc127f4054")
_DEFAULT_BASE_URL = os.getenv("ALPHAGEN_BST_BASE_URL", "https://dashscope.aliyuncs.com/compatible-mode/v1")
_DEFAULT_MODEL_NAME = os.getenv("ALPHAGEN_BST_MODEL", "qwen3-max")
